...
\toprule
\textbf{Característica} & \textbf{Seong et al. (MIT, 2023)} & \textbf{Baseline 2025 (MATLAB)} & \textbf{Nossa Implementação 2026 (Python)} \\
\midrule
...
\end{equation}
Esta formulação corrige o erro do código prévio de 2025 (no qual constava $c = 2\sqrt{R^2-\Delta y^2}$), prevenindo qualquer violação física da parede sólida do tubo. A \autoref{fig:reconstrucao_frame16} ilustra a correspondência entre a imagem 2D e os elipsoides 3D reconstituídos.
